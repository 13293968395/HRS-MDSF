...
class NH_HazeDataset(Dataset):
    def __init__(self, hazed_image_files, dehazed_image_files, root_dir, crop=False, crop_size=60, multi_scale=False, rotation=False, color_augment=False, transform=None):
        """
        Args:
