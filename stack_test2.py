...
SAMPLE_DIR = "./new_dataset3/test/hazy"
...
def main():
    ...
    if os.path.exists(FILE + EXPDIR) == False:
        os.makedirs(FILE + EXPDIR)
    ...
    for images_name in os.listdir(SAMPLE_DIR):
        with torch.no_grad():
            ...
            feature[s]['lv3_1'] = encoder[s]['lv3'](
                images['lv3_1'] + residual[ps]['lv1'][:, :, 0:int(H / 2), 0:int(W / 2)])
            feature[s]['lv3_2'] = encoder[s]['lv3'](
                images['lv3_2'] + residual[ps]['lv1'][:, :, 0:int(H / 2), int(W / 2):W])
            feature[s]['lv3_3'] = encoder[s]['lv3'](
                images['lv3_3'] + residual[ps]['lv1'][:, :, int(H / 2):H, 0:int(W / 2)])
            feature[s]['lv3_4'] = encoder[s]['lv3'](
                images['lv3_4'] + residual[ps]['lv1'][:, :, int(H / 2):H, int(W / 2):W])
